...
import 'package:evon_calories_tracker/services/database.dart';
import 'package:evon_calories_tracker/utils/theme_colors.dart';
...
class _DayViewState extends State<DayViewScreen> {
  ...
  Future<void> _getUserAccountIDAndInitializeDatabaseService() async {
    User_Account_ID = await storage.read(key: "token");
    databaseService =
        DatabaseService(uid: User_Account_ID!, currentDate: DateTime.now());
  }
  ...
  void initState() {
    ...
    addFoodTrack = FoodTrackTask(
        ...
        createdOn: _value,
        grams: 0);
    databaseService.getFoodTrackData(User_Account_ID);

    _getUserAccountIDAndInitializeDatabaseService();
  }
